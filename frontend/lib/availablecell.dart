...
class AvailableCellPageState extends State<AvailableCellPage> {
  ...
  Widget buildLeftColumn(RoomDetail details) {
    final half = (details.features.length / 2).ceil();
    final leftFeatures = details.features.take(half).toList();
    final rightFeatures = details.features.skip(half).toList();
                    ...
                    Row(
                      ...
                      children: [
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: leftFeatures.map((feature) {
                              return Padding(
                                padding: const EdgeInsets.symmetric(
                                  vertical: 4,
                                ),
                        ...
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: rightFeatures.map((feature) {
                              return Padding(
                                padding: const EdgeInsets.symmetric(
                                  vertical: 4,
                                ),
